...
{
    //TAG must be 23 or less characters
    ...
    protected void onHandleIntent(Intent intent)
    {
        ...
        // check if error exists with event in which case, log the error message
        ...
        // Get the transition type - should be entering
    ...
    private void sendNotification(String notificationDetails)
    {
        ...
        builder.setSmallIcon(R.mipmap.ic_launcher)
                ...
                .setContentTitle(getString(R.string.geofence_enter_trigger_notify))
